...
Reference full template: `C:/DEV/robo-mt5-v2/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/DEV/robo-mt5-v2/.opencode/get-shit-done/templates/state.md`.
