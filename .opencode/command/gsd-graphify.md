...
Knowledge graph is disabled. To activate:
  ...
  node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
