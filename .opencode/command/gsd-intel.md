...
Intel system is disabled. To activate:
  ...
  node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node C:/DEV/robo-mt5-v2/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
