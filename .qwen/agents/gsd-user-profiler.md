...
<reference>
@C:/DEV/robo-mt5-v2/.qwen/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/DEV/robo-mt5-v2/.qwen/get-shit-done/references/user-profiling.md` to load:
