...
Use template from `C:/DEV/robo-mt5-v2/.qwen/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/DEV/robo-mt5-v2/.qwen/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/DEV/robo-mt5-v2/.qwen/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
