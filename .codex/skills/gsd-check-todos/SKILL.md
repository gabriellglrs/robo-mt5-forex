...
<execution_context>
@C:/DEV/robo-mt5-v2/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@C:/DEV/robo-mt5-v2/.codex/get-shit-done/workflows/check-todos.md`.
