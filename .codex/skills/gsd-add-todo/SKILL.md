...
<execution_context>
@C:/DEV/robo-mt5-v2/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@C:/DEV/robo-mt5-v2/.codex/get-shit-done/workflows/add-todo.md`.
