...
<execution_context>
@C:/DEV/robo-mt5-v2/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@C:/DEV/robo-mt5-v2/.codex/get-shit-done/workflows/add-phase.md`.
