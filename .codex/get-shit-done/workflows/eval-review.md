...
```bash
AUDITOR_MODEL=$(node "C:/DEV/robo-mt5-v2/.codex/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/DEV/robo-mt5-v2/.codex/agents/gsd-eval-auditor.md for instructions.
