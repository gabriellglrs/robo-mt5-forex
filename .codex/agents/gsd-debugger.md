...
<required_reading>
@C:/DEV/robo-mt5-v2/.codex/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/DEV/robo-mt5-v2/.codex
                  → checks C:/DEV/robo-mt5-v2/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/DEV/robo-mt5-v2/.codex/get-shit-done
                  → writes to C:/DEV/robo-mt5-v2/.codex/get-shit-done/hooks/
...
@C:/DEV/robo-mt5-v2/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/DEV/robo-mt5-v2/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/DEV/robo-mt5-v2/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/DEV/robo-mt5-v2/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/DEV/robo-mt5-v2/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
